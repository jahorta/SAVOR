...
void WorkflowLauncherPage::launchStandaloneUnit()
{
    ...
    launchButton_->setEnabled(false);
    const auto graphResult = soasimqt2::db::SimCoreDbWorkflowService::EnsureStandaloneWorkflowUnitGraph(
        soasimqt2::db::StandaloneWorkflowUnitGraphRequest{
...
void WorkflowLauncherPage::refreshAuthoredRefsForStandaloneUnit(const WorkflowUnitDefinition& unit)
{
    ...
    } else if (requirement.ref_kind == "authoring.template") {

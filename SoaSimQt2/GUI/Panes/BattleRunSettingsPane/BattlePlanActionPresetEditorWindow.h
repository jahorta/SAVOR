...
public:
    ...
    void loadSnapshot(const simcore::db::BattlePlanActionPresetSnapshot& snapshot, bool duplicate);
    void loadNew();
...
private:
    ...
    bool buildDraft(soasimqt2::db::BattlePlanActionPresetDraft& draft, QString* errorText) const;
    bool canSaveCurrentInPlace(const soasimqt2::db::BattlePlanActionPresetDraft& draft) const;
    void saveAsNew();
    void saveCurrent();
    void applyLoadedSnapshot(const simcore::db::BattlePlanActionPresetSnapshot& snapshot);
    ...
    simcore::db::BattlePlanActionPresetSnapshot loadedSnapshot_{};

...
QString predicateText(const simcore::db::PredicateSpecSnapshot& predicate)
{
...
QString battlePlanText(const simcore::db::BattlePlanSnapshot& plan)
{
    int actionCount = 0;
...
{
    const auto predicates = soasimqt2::db::SimCoreDbAuthoringService::ListPredicateSpecs();
    if (!predicates.ok) {

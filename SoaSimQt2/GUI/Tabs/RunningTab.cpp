...
{
    soasimqt2::db::WorkflowListRequest workflowRequest{};
    workflowRequest.limit = 50;
    const auto workflows = soasimqt2::db::SimCoreDbWorkflowService::ListWorkflowInstances(workflowRequest);
    ...
    simcore::db::UiReadJobListQuery jobQuery{};
    const auto jobs = soasimqt2::db::SimCoreDbJobService::FetchJobsPage(jobQuery, std::nullopt, std::nullopt, 50);
    int runningJobs = 0;
    int queuedJobs = 0;
    int failedJobs = 0;
    if (jobs.ok) {

...
CREATE TABLE IF NOT EXISTS asp_run (
...
CREATE TABLE IF NOT EXISTS asp_state_ref (
...
CREATE TABLE IF NOT EXISTS asp_lineage_edge (
...
CREATE TABLE IF NOT EXISTS asp_artifact_ref (
...
CREATE TABLE IF NOT EXISTS asp_outbox_message (

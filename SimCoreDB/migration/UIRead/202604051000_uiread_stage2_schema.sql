...
CREATE TABLE IF NOT EXISTS ui_job_summary (
...
CREATE TABLE IF NOT EXISTS ui_job_detail (
    job_id INTEGER PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS ui_job_artifact (
...
CREATE TABLE IF NOT EXISTS ui_seed_probe_summary (
...
CREATE TABLE IF NOT EXISTS ui_seed_probe_delta_point (
...
CREATE TABLE IF NOT EXISTS ui_battle_group (
...
CREATE TABLE IF NOT EXISTS ui_battle_wave (
...
CREATE TABLE IF NOT EXISTS ui_battle_turn_job (
...
CREATE TABLE IF NOT EXISTS ui_battle_followup (
    turn_job_id INTEGER PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS ui_artifact_browser (
...
CREATE TABLE IF NOT EXISTS ui_archive_catalog (
...
CREATE INDEX IF NOT EXISTS ix_ui_job_summary_list
    ON ui_job_summary(state, queued_at_utc DESC, priority DESC);

CREATE INDEX IF NOT EXISTS ix_ui_seed_probe_summary_list
    ON ui_seed_probe_summary(status, requested_at_utc DESC);

CREATE INDEX IF NOT EXISTS ix_ui_seed_probe_delta_probe_run
    ON ui_seed_probe_delta_point(probe_run_id, source_family);

CREATE INDEX IF NOT EXISTS ix_ui_battle_wave_group_turn
    ON ui_battle_wave(battle_set_id, turn_index, wave_id);

CREATE INDEX IF NOT EXISTS ix_ui_battle_followup_status

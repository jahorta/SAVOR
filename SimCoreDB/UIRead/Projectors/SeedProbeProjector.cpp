...
bool SeedProbeProjector::ProjectAll(std::string* error_out) {
    ...
    constexpr const char* kSql =
        ...
        "SELECT r.probe_run_id,r.probe_set_id,r.entry_savestate_id,r.seed_probe_spec_id,r.codec_version,"
        "r.status,res.neutral_seed_value,res.grid_count,res.unique_count,r.requested_at_utc,r.completed_at_utc "
        "FROM sp_probe_run r "

...
struct ProcessWorkerSnapshot {
    ...
    bool runtime_contract_received{ false };
...
public:
    ...
    std::optional<runtime::WorkerRuntimeContractV1> runtime_contract() const;
...
private:
    ...
    std::optional<runtime::WorkerRuntimeContractV1> runtime_contract_;

...
CREATE TABLE IF NOT EXISTS ui_workflow_unit_activation (
...
CREATE TABLE IF NOT EXISTS ui_workflow_unit_activation_edge (
...
ALTER TABLE ui_workflow_step
    ADD COLUMN workflow_unit_activation_id INTEGER NULL;

CREATE INDEX IF NOT EXISTS ix_ui_workflow_unit_activation_instance_state
    ON ui_workflow_unit_activation(workflow_instance_id, state, created_at_utc ASC);

CREATE INDEX IF NOT EXISTS ix_ui_workflow_step_activation

...
CREATE TABLE IF NOT EXISTS ar_archive_package (
...
CREATE TABLE IF NOT EXISTS ar_archive_item (
...
CREATE TABLE IF NOT EXISTS ar_rehydrate_request (
...
CREATE TABLE IF NOT EXISTS ar_rehydrate_map (
...
CREATE INDEX IF NOT EXISTS ix_ar_archive_item_package
    ON ar_archive_item(archive_package_id, item_kind);

CREATE INDEX IF NOT EXISTS ix_ar_rehydrate_request_status

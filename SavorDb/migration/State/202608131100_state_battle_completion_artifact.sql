...
ALTER TABLE state_artifact RENAME TO state_artifact_before_battle_completion;
...
CREATE TABLE state_artifact (
    ...
    artifact_kind TEXT NOT NULL CHECK(artifact_kind IN
        ('DTM', 'DTMINI', 'TAS_MOVIE_ITINERARY', 'SAV', 'LOG',
         'BATTLE_CONTEXT', 'BATTLE_COMPLETION', 'OTHER')),
...
SELECT artifact_id,sha256,size_bytes,compression_kind,filename,file_ext,
       artifact_kind,created_at_utc
FROM state_artifact_before_battle_completion;

DROP TABLE state_artifact_before_battle_completion;

...
CREATE TABLE IF NOT EXISTS exec_job_event (
...
CREATE TABLE IF NOT EXISTS exec_trigger (
...
CREATE TABLE IF NOT EXISTS exec_outbox_message (
...
CREATE TABLE IF NOT EXISTS exec_archive_cursor (
...
CREATE INDEX IF NOT EXISTS ix_exec_job_job_set_state_queue_desc

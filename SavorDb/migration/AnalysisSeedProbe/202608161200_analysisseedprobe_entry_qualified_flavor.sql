...
CREATE TABLE sp_probe_set_new (
    probe_set_id INTEGER PRIMARY KEY,
    name TEXT NOT NULL,
    probe_flavor TEXT NOT NULL CHECK(probe_flavor IN (
        'BATTLE_PRE',
        'DUNGEON_PRE',
        'OVERWORLD_PRE',
        'FIELD_RETURN',
...
INSERT INTO sp_probe_set_new(
    probe_set_id,
    name,
    probe_flavor,
    breakpoint_policy_name,
    dungeon_segment_file_num,
    dungeon_segment_file_letter,
    dungeon_segment_code,
    segment_source_kind,
    created_at_utc)
SELECT
    probe_set_id,
...
ALTER TABLE sp_probe_set_new RENAME TO sp_probe_set;

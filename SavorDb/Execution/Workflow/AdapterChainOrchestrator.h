...
public:
    ...
    std::optional<programdb::ResultMapPayload> OnJobTerminal(std::string_view step_kind, std::int64_t job_id, const savor::PRResult& result, AdapterChainTrace* trace = nullptr, std::string* error_out = nullptr) const;

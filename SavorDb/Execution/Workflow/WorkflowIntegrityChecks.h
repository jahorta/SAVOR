...
struct WorkflowIntegrityReport {
    ...
    int non_settled_step_in_completed_instance_count = 0;
    int non_settled_step_in_terminal_instance_count = 0;
    ...
    bool IsClean() const {
        return dangling_edge_count == 0
            ...
            && non_settled_step_in_completed_instance_count == 0
            && non_settled_step_in_terminal_instance_count == 0

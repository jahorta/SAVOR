...
inline constexpr EventDispatchBinding kPayloadDispatchBindingsV1[] = {
    ...
    { { "Execution.WorkflowStepInterrupted.v1", 1 }, PayloadResolverContract::ExecutionWorkflowJobV1 },
    { { "Execution.WorkflowStepCanceled.v1", 1 }, PayloadResolverContract::ExecutionWorkflowJobV1 },

...
constexpr FirstBattleActorStats kVyse{
    ...
    .motion_turn_speed = 25.0999928f,
    .motion_turn_speed_bits = 0x41C8CCC9u,
...
constexpr FirstBattleActorStats kAika{
    ...
    .motion_speeds_known = true,
    .motion_turn_speed = 22.0999832f,
    .motion_turn_speed_bits = 0x41B0CCC4u,
    .motion_turn_speed_known = true,
    .attack_known = true,
    .hit_known = true,
};
...
constexpr FirstBattleActorStats kSoldier{
    ...
    .motion_speeds_known = true,
    .motion_turn_speed = 20.0999737f,
    .motion_turn_speed_bits = 0x41A0CCBFu,
    .motion_turn_speed_known = true,
    .attack_known = true,
    .hit_known = true,
    .defense_known = true,

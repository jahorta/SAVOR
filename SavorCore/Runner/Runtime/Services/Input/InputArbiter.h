...
public:
    ...
    InputArbiterOperationReceipt CommitStateEpoch(
        StateEpoch epoch) noexcept;
    InputArbiterOperationReceipt InvalidateForStateReplacement(
...
private:
    ...
    [[nodiscard]] bool IsCurrent(StateEpoch epoch) const noexcept;

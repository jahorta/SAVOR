...
namespace savor::context::key {
    ...
    core::kKeys, seed::kKeys, tas::kKeys, tasframedetector::kKeys, battle::kKeys, navigation::kKeys,
    };
    static constexpr std::size_t kTablesSizes[] = {
      core::kCount, seed::kCount, tas::kCount, tasframedetector::kCount, battle::kCount, navigation::kCount
    };

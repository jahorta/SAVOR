...
CREATE TABLE state_tas_movie_variant (
...
CREATE TABLE state_outbox_message (
...
CREATE INDEX ix_state_savestate_derivation_from
    ON state_savestate_derivation(from_savestate_id);
CREATE INDEX ix_state_savestate_derivation_to
    ON state_savestate_derivation(to_savestate_id);
CREATE INDEX ix_state_outbox_unpublished

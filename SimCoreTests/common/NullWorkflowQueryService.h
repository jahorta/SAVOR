...
public:
    ...
    std::optional<simcore::db::execution::workflow::WorkflowStepTerminalSnapshot> GetStepTerminalSnapshotForJob(std::int64_t) const override {
        return std::nullopt;
    }
    std::vector<simcore::db::execution::workflow::WorkflowStepTerminalSnapshot> ListTerminalReadyStepSnapshots(std::size_t) const override {
        return {};
    }

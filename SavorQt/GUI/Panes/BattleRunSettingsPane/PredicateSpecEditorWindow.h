...
public:
    ...
    void loadSnapshot(const savor::db::PredicateSpecSnapshot& snapshot, bool duplicate);
...
private:
    ...
    void setComparison(savor::db::PredicateComparisonOp op);
    savor::db::PredicateComparisonOp comparison() const;

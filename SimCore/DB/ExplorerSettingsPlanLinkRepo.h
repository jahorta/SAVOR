...
namespace simcore {
    namespace db {
        ...
        struct ExplorerSettingsPlanLinkRepo {
            ...
            static std::future<DbResult<std::vector<SettingsPlanLinkRow>>> ListAsync(int64_t settings_id, RetryPolicy rp = {});
            ...
            static inline DbResult<std::vector<SettingsPlanLinkRow>> List(int64_t settings_id) { return ListAsync(settings_id).get(); }

...
namespace simcore {
    namespace db {
        ...
        struct ExplorerRunRepo {
            // Async
            static std::future<DbResult<int64_t>> IdempotentCreateAsync(int64_t group_id, int64_t settings_id, int64_t plan_id, int64_t delta_seed_id, RetryPolicy rp = {});
            ...
            static std::future<DbResult<void>> SetGroupIdAsync(int64_t run_id, int64_t group_id, RetryPolicy rp = {}); 
            static std::future<DbResult<std::vector<ExplorerRunRow>>> ListByGroupAsync(int64_t group_id, RetryPolicy rp = {});

            // Blocking convenience
            static inline DbResult<int64_t> IdempotentCreate(int64_t group_id, int64_t settings_id, int64_t plan_id, int64_t delta_seed_id) { return IdempotentCreateAsync(group_id, settings_id, plan_id, delta_seed_id).get(); }
            ...
            static inline DbResult<void> SetGroupId(int64_t run_id, int64_t group_id) { return SetGroupIdAsync(run_id, group_id).get(); }
            static inline DbResult<std::vector<ExplorerRunRow>> ListByGroup(int64_t group_id) { return ListByGroupAsync(group_id).get(); }
        };

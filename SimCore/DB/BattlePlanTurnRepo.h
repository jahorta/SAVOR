...
namespace simcore {
    namespace db {
        ...
        struct BattlePlanTurnByPlanRow { int64_t plan_id; int32_t turn_index; int32_t fake_atk_count; };
        struct TurnActorBindingByPlan { int32_t actor_index; int64_t atom_id; };

        struct BattlePlanTurnRepo {
            static std::future<DbResult<void>> UpsertTurnByPlanAsync(int64_t plan_id, int32_t turn_index, int32_t fake_atk_count, RetryPolicy rp = {});
            ...
            static std::future<DbResult<void>> ReplaceTurnByPlanAsync(int64_t plan_id, int32_t turn_index, int32_t fake_atk_count, std::vector<TurnActorBindingByPlan> actors, RetryPolicy rp = {});
            ...
            static inline DbResult<void> UpsertTurnByPlan(int64_t plan_id, int32_t turn_index, int32_t fake_atk_count) {
                return UpsertTurnByPlanAsync(plan_id, turn_index, fake_atk_count).get();
            }
            ...
            static inline DbResult<void> ReplaceTurnByPlan(int64_t plan_id, int32_t turn_index, int32_t fake_atk_count, std::vector<TurnActorBindingByPlan> actors) {
                return ReplaceTurnByPlanAsync(plan_id, turn_index, fake_atk_count, std::move(actors)).get();
            }
